...
const Friends = () => {
    return (
        <div className="mt-12 md:mt-16 lg:mt-28 mx-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="card card-compact max-h-80  bg-base-100 shadow-xl">
